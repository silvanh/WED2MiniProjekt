...
require([,'libraries/jasmine-boot'], function () {
    require(['tests/controllers/eventListControllerTest', 'tests/model/eventTest', 'tests/model/guestTest', 'tests/repository/eventRepositoryTest', 'tests/repository/guestRepositoryTest'], function(){
        //trigger Jasmine
        window.onload();
    });
});